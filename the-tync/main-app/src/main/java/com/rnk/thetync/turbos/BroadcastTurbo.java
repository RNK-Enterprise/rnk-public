...
public class BroadcastTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BroadcastTurbo.class);
    private final String name = "BroadcastTurbo";
    ...
    public BroadcastTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 20.0; }
