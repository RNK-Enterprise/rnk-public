...
public class ContainerTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ContainerTurbo.class);
    private final String name = "ContainerTurbo";
    ...
    public ContainerTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
