...
public class BootstrapTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BootstrapTurbo.class);
    private final String name = "BootstrapTurbo";
    ...
    public BootstrapTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 18.0; }
