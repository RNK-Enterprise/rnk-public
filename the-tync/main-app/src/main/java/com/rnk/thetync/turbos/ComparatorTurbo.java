...
public class ComparatorTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ComparatorTurbo.class);
    private final String name = "ComparatorTurbo";
    ...
    public ComparatorTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
