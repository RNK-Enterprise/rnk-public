...
public class BeautificationTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BeautificationTurbo.class);
    private final String name = "BeautificationTurbo";
    ...
    public BeautificationTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 8.0; }
