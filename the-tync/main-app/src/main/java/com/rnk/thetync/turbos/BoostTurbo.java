...
public class BoostTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BoostTurbo.class);
    private final String name = "BoostTurbo";
    ...
    public BoostTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
