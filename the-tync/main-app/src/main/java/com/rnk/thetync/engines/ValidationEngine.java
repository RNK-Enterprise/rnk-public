 ...
 *
 * <p>Contract: receives the shared {@link EngineContext}, tests transformation
 * integrity and certifies mods, and returns an {@link EngineResult}.</p>
 */
public class ValidationEngine implements Engine {
    ...
    public ValidationEngine(MeterRegistry meterRegistry) {
