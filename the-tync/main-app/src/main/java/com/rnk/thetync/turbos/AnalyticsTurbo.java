...
public class AnalyticsTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AnalyticsTurbo.class);
    private final String name = "AnalyticsTurbo";
    ...
    public AnalyticsTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
