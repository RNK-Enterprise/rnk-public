...
public class BenchmarkTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BenchmarkTurbo.class);
    private final String name = "BenchmarkTurbo";
    ...
    public BenchmarkTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
