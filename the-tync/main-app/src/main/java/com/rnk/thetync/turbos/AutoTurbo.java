...
public class AutoTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AutoTurbo.class);
    private final String name = "AutoTurbo";
    ...
    public AutoTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 4.0; }
