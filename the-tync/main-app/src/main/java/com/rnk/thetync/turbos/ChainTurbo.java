...
public class ChainTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ChainTurbo.class);
    private final String name = "ChainTurbo";
    ...
    public ChainTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 23.0; }
