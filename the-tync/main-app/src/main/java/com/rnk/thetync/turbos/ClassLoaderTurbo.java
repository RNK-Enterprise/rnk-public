...
public class ClassLoaderTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ClassLoaderTurbo.class);
    private final String name = "ClassLoaderTurbo";
    ...
    public ClassLoaderTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 26.0; }
