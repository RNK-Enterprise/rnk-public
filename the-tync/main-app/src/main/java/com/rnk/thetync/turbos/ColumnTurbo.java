...
public class ColumnTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ColumnTurbo.class);
    private final String name = "ColumnTurbo";
    ...
    public ColumnTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 38.0; }
