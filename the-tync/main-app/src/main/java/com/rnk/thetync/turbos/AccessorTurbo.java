...
/**
 * AccessorTurbo - High-performance acceleration module.
 */
public class AccessorTurbo implements Turbo {

    private static final Logger logger = LoggerFactory.getLogger(AccessorTurbo.class);

    private final String name = "AccessorTurbo";
    ...
    public AccessorTurbo(MeterRegistry meterRegistry) {
    ...
    public Mono<Void> initialize() {
        return Mono.fromCallable(() -> {
            logger.info("Initializing AccessorTurbo v{}", version);
