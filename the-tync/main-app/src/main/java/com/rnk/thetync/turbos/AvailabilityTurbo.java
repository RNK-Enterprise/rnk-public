...
public class AvailabilityTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AvailabilityTurbo.class);
    private final String name = "AvailabilityTurbo";
    ...
    public AvailabilityTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 5.0; }
