...
public class CollaborationTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CollaborationTurbo.class);
    private final String name = "CollaborationTurbo";
    ...
    public CollaborationTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 35.0; }
