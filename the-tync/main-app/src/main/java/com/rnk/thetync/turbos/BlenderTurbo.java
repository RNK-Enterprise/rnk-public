...
public class BlenderTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BlenderTurbo.class);
    private final String name = "BlenderTurbo";
    ...
    public BlenderTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
