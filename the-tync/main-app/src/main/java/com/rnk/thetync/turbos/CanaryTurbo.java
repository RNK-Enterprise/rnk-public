...
public class CanaryTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CanaryTurbo.class);
    private final String name = "CanaryTurbo";
    ...
    public CanaryTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 17.0; }
