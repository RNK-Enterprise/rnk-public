...
public class AssertionTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AssertionTurbo.class);
    private final String name = "AssertionTurbo";
    ...
    public AssertionTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 11.0; }
