...
public class BudgetTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BudgetTurbo.class);
    private final String name = "BudgetTurbo";
    ...
    public BudgetTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
