...
public class CommentTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CommentTurbo.class);
    private final String name = "CommentTurbo";
    ...
    public CommentTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 39.0; }
