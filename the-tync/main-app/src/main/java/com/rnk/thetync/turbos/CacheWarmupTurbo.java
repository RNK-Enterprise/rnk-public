...
public class CacheWarmupTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CacheWarmupTurbo.class);
    private final String name = "CacheWarmupTurbo";
    ...
    public CacheWarmupTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
