...
public class BatchTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BatchTurbo.class);
    private final String name = "BatchTurbo";
    ...
    public BatchTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
