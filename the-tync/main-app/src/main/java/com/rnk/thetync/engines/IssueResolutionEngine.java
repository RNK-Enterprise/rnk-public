 ...
 *
 * <p>Contract: receives the shared {@link EngineContext}, automatically
 * resolves detected issues, and returns an {@link EngineResult}.</p>
 */
public class IssueResolutionEngine implements Engine {

    private static final Logger logger = LoggerFactory.getLogger(IssueResolutionEngine.class);
    ...
    public IssueResolutionEngine(MeterRegistry meterRegistry) {
