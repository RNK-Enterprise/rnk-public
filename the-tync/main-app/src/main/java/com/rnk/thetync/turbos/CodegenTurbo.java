...
public class CodegenTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CodegenTurbo.class);
    private final String name = "CodegenTurbo";
    ...
    public CodegenTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 33.0; }
