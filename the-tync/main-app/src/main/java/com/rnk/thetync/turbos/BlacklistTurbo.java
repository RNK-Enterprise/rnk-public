...
public class BlacklistTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BlacklistTurbo.class);
    private final String name = "BlacklistTurbo";
    ...
    public BlacklistTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 13.0; }
