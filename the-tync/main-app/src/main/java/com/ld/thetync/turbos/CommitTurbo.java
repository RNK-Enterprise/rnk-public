...
public class CommitTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CommitTurbo.class);
    private final String name = "CommitTurbo";
    ...
    public CommitTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 40.0; }
