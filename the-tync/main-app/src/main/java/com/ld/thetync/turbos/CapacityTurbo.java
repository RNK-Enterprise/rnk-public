...
public class CapacityTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CapacityTurbo.class);
    private final String name = "CapacityTurbo";
    ...
    public CapacityTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
