...
public class AuditTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AuditTurbo.class);
    private final String name = "AuditTurbo";
    ...
    public AuditTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
