...
public class CheckpointTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CheckpointTurbo.class);
    private final String name = "CheckpointTurbo";
    ...
    public CheckpointTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 25.0; }
