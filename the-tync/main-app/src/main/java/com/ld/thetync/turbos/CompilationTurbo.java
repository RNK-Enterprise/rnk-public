...
public class CompilationTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CompilationTurbo.class);
    private final String name = "CompilationTurbo";
    ...
    public CompilationTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
