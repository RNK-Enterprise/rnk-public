...
public class AuthorizationTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AuthorizationTurbo.class);
    private final String name = "AuthorizationTurbo";
    ...
    public AuthorizationTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 15.0; }
