...
public class BehaviorTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BehaviorTurbo.class);
    private final String name = "BehaviorTurbo";
    ...
    public BehaviorTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
