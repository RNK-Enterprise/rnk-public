...
public class AnnouncementTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AnnouncementTurbo.class);
    private final String name = "AnnouncementTurbo";
    ...
    public AnnouncementTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 9.0; }
