...
public class CloudTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CloudTurbo.class);
    private final String name = "CloudTurbo";
    ...
    public CloudTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 30.0; }
