...
/**
 * AggregationTurbo - High-performance acceleration module.
 */
public class AggregationTurbo implements Turbo {

    private static final Logger logger = LoggerFactory.getLogger(AggregationTurbo.class);

    private final String name = "AggregationTurbo";
    ...
    public AggregationTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 6.0; }
