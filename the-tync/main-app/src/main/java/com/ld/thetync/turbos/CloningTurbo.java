...
public class CloningTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CloningTurbo.class);
    private final String name = "CloningTurbo";
    ...
    public CloningTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 29.0; }
