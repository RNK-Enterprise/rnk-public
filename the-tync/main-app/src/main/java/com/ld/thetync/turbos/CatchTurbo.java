...
public class CatchTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CatchTurbo.class);
    private final String name = "CatchTurbo";
    ...
    public CatchTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
