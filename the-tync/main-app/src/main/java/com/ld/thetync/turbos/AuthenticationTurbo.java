...
public class AuthenticationTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AuthenticationTurbo.class);
    private final String name = "AuthenticationTurbo";
    ...
    public AuthenticationTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 14.0; }
