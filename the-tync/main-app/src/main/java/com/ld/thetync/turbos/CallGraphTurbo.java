...
public class CallGraphTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CallGraphTurbo.class);
    private final String name = "CallGraphTurbo";
    ...
    public CallGraphTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
