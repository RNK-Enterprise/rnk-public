 ...
 *
 * <p>Contract: receives the shared {@link EngineContext}, provides seamless
 * cross-loader compatibility, and returns an {@link EngineResult}.</p>
 */
public class MultiLoaderBridgeEngine implements Engine {

    private static final Logger logger = LoggerFactory.getLogger(MultiLoaderBridgeEngine.class);
    ...
    public MultiLoaderBridgeEngine(MeterRegistry meterRegistry) {
        this.meterRegistry = meterRegistry;
    }

    @Override
    public String getName() {
        return "MultiLoaderBridgeEngine";
    }
