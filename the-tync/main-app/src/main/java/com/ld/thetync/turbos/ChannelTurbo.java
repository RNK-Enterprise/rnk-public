...
public class ChannelTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ChannelTurbo.class);
    private final String name = "ChannelTurbo";
    ...
    public ChannelTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 24.0; }
