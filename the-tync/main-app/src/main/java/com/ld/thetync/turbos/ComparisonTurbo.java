...
public class ComparisonTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ComparisonTurbo.class);
    private final String name = "ComparisonTurbo";
    ...
    public ComparisonTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
