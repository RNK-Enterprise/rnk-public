...
public class CaptchaTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CaptchaTurbo.class);
    private final String name = "CaptchaTurbo";
    ...
    public CaptchaTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
