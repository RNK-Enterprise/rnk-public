...
public class AssemblyTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AssemblyTurbo.class);
    private final String name = "AssemblyTurbo";
    ...
    public AssemblyTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
