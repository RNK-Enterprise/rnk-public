...
public class BoundaryTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BoundaryTurbo.class);
    private final String name = "BoundaryTurbo";
    ...
    public BoundaryTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 19.0; }
