...
public class ClusterTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ClusterTurbo.class);
    private final String name = "ClusterTurbo";
    ...
    public ClusterTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 31.0; }
