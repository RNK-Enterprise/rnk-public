...
public class ClassificationTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ClassificationTurbo.class);
    private final String name = "ClassificationTurbo";
    ...
    public ClassificationTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 27.0; }
