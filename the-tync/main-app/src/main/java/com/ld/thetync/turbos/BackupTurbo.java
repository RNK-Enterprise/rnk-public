...
public class BackupTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BackupTurbo.class);
    private final String name = "BackupTurbo";
    ...
    public BackupTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
