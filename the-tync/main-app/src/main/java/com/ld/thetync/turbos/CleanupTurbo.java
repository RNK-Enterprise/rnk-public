...
public class CleanupTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CleanupTurbo.class);
    private final String name = "CleanupTurbo";
    ...
    public CleanupTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 28.0; }
