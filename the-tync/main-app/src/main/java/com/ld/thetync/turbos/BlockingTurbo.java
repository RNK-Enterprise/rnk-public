...
public class BlockingTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BlockingTurbo.class);
    private final String name = "BlockingTurbo";
    ...
    public BlockingTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
