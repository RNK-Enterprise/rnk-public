...
public class CompeterTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CompeterTurbo.class);
    private final String name = "CompeterTurbo";
    ...
    public CompeterTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
