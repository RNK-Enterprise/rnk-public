...
public class BrokerTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BrokerTurbo.class);
    private final String name = "BrokerTurbo";
    ...
    public BrokerTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 21.0; }
