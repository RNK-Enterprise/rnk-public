...
public class ColorTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ColorTurbo.class);
    private final String name = "ColorTurbo";
    ...
    public ColorTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 37.0; }
