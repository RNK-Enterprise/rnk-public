 ...
 *
 * <p>Contract: receives the shared {@link EngineContext}, translates the
 * Universal API Layer to native loader APIs, and returns an {@link EngineResult}.</p>
 */
public class ApiBridgeEngine implements Engine {

    private static final Logger logger = LoggerFactory.getLogger(ApiBridgeEngine.class);
    ...
    public ApiBridgeEngine(MeterRegistry meterRegistry) {
        this.meterRegistry = meterRegistry;
    }

    @Override
    public String getName() {
        return "ApiBridgeEngine";
    }
