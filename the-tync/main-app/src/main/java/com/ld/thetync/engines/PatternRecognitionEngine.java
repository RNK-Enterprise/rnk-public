 ...
 *
 * <p>Contract: receives the shared {@link EngineContext}, detects code
 * patterns and bugs, and returns an {@link EngineResult}.</p>
 */
public class PatternRecognitionEngine implements Engine {

    private static final Logger logger = LoggerFactory.getLogger(PatternRecognitionEngine.class);
    ...
    public PatternRecognitionEngine(MeterRegistry meterRegistry) {
