 ...
 *
 * <p>Contract: receives the shared {@link EngineContext}, handles runtime
 * injection into running JVMs, and returns an {@link EngineResult}.</p>
 */
public class InjectionEngine implements Engine {
    ...
    public InjectionEngine(MeterRegistry meterRegistry, Instrumentation instrumentation) {
