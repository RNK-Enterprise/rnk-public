...
public class BuildTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BuildTurbo.class);
    private final String name = "BuildTurbo";
    ...
    public BuildTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
