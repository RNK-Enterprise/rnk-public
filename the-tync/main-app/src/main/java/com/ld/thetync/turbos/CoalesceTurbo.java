...
public class CoalesceTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CoalesceTurbo.class);
    private final String name = "CoalesceTurbo";
    ...
    public CoalesceTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 32.0; }
