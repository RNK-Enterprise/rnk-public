 ...
 *
 * <p>Contract: receives the shared {@link EngineContext}, generates dynamic
 * compatibility shims between loader APIs, and returns an {@link EngineResult}.</p>
 */
public class ShimGenerationEngine implements Engine {

    private static final Logger logger = LoggerFactory.getLogger(ShimGenerationEngine.class);
    ...
    public ShimGenerationEngine(MeterRegistry meterRegistry) {
        this.meterRegistry = meterRegistry;
    }

    @Override
    public String getName() {
        return "ShimGenerationEngine";
    }
