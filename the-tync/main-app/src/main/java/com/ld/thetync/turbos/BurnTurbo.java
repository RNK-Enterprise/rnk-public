...
public class BurnTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BurnTurbo.class);
    private final String name = "BurnTurbo";
    ...
    public BurnTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
