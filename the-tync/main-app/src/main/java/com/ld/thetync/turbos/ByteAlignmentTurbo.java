...
public class ByteAlignmentTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ByteAlignmentTurbo.class);
    private final String name = "ByteAlignmentTurbo";
    ...
    public ByteAlignmentTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
