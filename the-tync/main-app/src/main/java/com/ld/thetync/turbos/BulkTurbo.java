...
public class BulkTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BulkTurbo.class);
    private final String name = "BulkTurbo";
    ...
    public BulkTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
