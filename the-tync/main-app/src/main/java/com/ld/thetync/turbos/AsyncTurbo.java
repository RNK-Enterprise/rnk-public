...
public class AsyncTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(AsyncTurbo.class);
    private final String name = "AsyncTurbo";
    ...
    public AsyncTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
