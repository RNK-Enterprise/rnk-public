...
public class ConstraintTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ConstraintTurbo.class);
    private final String name = "ConstraintTurbo";
    ...
    public ConstraintTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 10.0; }
