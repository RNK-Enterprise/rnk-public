 ...
 *
 * <p>Contract: receives the shared {@link EngineContext}, maps APIs between
 * Minecraft loaders, and returns an {@link EngineResult}.</p>
 */
public class ApiMappingEngine implements Engine {

    private static final Logger logger = LoggerFactory.getLogger(ApiMappingEngine.class);
    ...
    public ApiMappingEngine(MeterRegistry meterRegistry) {
