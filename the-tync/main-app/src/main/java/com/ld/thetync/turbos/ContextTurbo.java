...
public class ContextTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(ContextTurbo.class);
    private final String name = "ContextTurbo";
    ...
    public ContextTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
