...
public class BindingTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BindingTurbo.class);
    private final String name = "BindingTurbo";
    ...
    public BindingTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
