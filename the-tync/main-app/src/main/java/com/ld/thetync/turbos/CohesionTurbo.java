...
public class CohesionTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CohesionTurbo.class);
    private final String name = "CohesionTurbo";
    ...
    public CohesionTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 34.0; }
