...
public class CollectorTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CollectorTurbo.class);
    private final String name = "CollectorTurbo";
    ...
    public CollectorTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 36.0; }
