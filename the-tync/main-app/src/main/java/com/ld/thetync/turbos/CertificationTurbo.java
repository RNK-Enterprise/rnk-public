...
public class CertificationTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CertificationTurbo.class);
    private final String name = "CertificationTurbo";
    ...
    public CertificationTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 22.0; }
