...
public class BusinessTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BusinessTurbo.class);
    private final String name = "BusinessTurbo";
    ...
    public BusinessTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
