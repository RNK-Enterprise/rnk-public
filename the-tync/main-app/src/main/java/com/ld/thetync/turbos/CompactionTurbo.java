...
public class CompactionTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CompactionTurbo.class);
    private final String name = "CompactionTurbo";
    ...
    public CompactionTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
