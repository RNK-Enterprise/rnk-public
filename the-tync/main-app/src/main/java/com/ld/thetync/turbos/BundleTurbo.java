...
public class BundleTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BundleTurbo.class);
    private final String name = "BundleTurbo";
    ...
    public BundleTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
