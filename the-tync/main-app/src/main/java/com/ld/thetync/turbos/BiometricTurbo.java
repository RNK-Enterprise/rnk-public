...
public class BiometricTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(BiometricTurbo.class);
    private final String name = "BiometricTurbo";
    ...
    public BiometricTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
    ...
    @Override public double getAccelerationFactor() { return 12.0; }
