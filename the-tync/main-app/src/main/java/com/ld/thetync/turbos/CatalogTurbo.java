...
public class CatalogTurbo implements Turbo {
    private static final Logger logger = LoggerFactory.getLogger(CatalogTurbo.class);
    private final String name = "CatalogTurbo";
    ...
    public CatalogTurbo(MeterRegistry meterRegistry) { this.meterRegistry = meterRegistry; }
